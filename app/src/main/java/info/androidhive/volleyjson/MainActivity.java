					...
					public void onResponse(JSONArray response) {
						...
						try {
							...
							for (int i = 0; i < response.length(); i++) {
								...
								String status = person.getString("StatusCode");
								String id = person.getString("CategoryId");
								String name = person.getString("CategoryName");

								jsonResponse += "Status: " + status + "\n\n";
								jsonResponse += "CategoryId: " + id + "\n\n";
								jsonResponse += "CategoryName: " + name + "\n\n";
